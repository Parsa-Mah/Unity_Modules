using PM.Time_Date_System.Models;

namespace PM.Util.Time_Date_System
{
    /// <summary>
    /// The core system for the custom time system
    /// </summary>
    public class TimeDateSystem : ITimeDateSystem
    {
        TimeModel timeModel;
        DateModel dateModel;
        ...
        public TimeDateSystem(int time)
        {
        ...
        private void AddADay()
        {
            ...
            if (dateModel.day > 27)
            {
                if (dateModel.month == 2 && dateModel.day == 29 && !global::System.DateTime.IsLeapYear(dateModel.year))
                {
                    dateModel.day = 0;
                    AddAMonth();
                    return;
                }
                if (dateModel.month == 2 && dateModel.day == 30 && global::System.DateTime.IsLeapYear(dateModel.year))
                {
                    dateModel.day = 0;
                    AddAMonth();
                    return;
